...
Clatsop Beach & 118 & \textbf{0.522} & 9.78 & 18.34 & High-skill$^\dagger$ \\
Coos Bay      &  89 & \textbf{0.616} & 8.08 & 22.87 & High-skill$^\dagger$ \\
\addlinespace
...
\end{tabular}
\vspace{0.3em}\\
\footnotesize{$^\dagger$Clatsop Beach and Coos Bay shift from Moderate/Low-skill on the standard eval to High-skill on the temporal holdout ($R^2 > 0.4$). Coos Bay's improvement ($R^2 = 0.616$ vs.\ $-0.038$) is particularly striking and may reflect a post-2019 regime shift in DA dynamics consistent with the 2019--2021 marine heatwave. Cannon Beach ($N = 13$, MAE $= 0.03$~\si{\microgrampeg}) has insufficient post-2019 measurements for stable per-site estimates; its near-zero errors indicate that essentially all 13 holdout observations are below-detection-limit, making this a degenerate sample rather than genuine forecast skill.}
\end{table}
