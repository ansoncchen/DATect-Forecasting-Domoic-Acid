...
\midrule
\textbf{Per-site sel.}$^{\dagger}$ & \textbf{0.215} [.096, .342] & \textbf{6.42} [5.78, 7.15] & \textbf{17.79} & --- \\
XGBoost          & 0.221 [.112, .339] & 6.38 [5.67, 7.08] & 17.72 & $-$.006 [$-$.020, $+$.007] \\
Random Forest    & 0.190 [.057, .320] & 6.47 [5.79, 7.25] & 18.07 & $+$.025 [$+$.005, $+$.045] \\
Linear (Ridge)   & 0.202 [.070, .324] & 6.62 [5.93, 7.39] & 17.94 & $+$.013 [$-$.020, $+$.042] \\
Na\"ive Persist. & $-$.426 [$-$.951, $-$.034] & 7.73 [6.84, 8.76] & 23.98 & $+$.641 [$+$.297, $+$1.12] \\
\bottomrule
\end{tabular*}
\vspace{0.3em}\\
...
\midrule
Copalis       & 277 & \textbf{.789} [.710, .844] & 2.81 [2.32, 3.40] & 5.28  & .823 & High \\
Twin Harbors  & 225 & \textbf{.594} [.473, .764] & 4.66 [3.36, 6.21] & 12.20 & .809 & High \\
Quinault      & 181 & \textbf{.582} [.498, .736] & 4.13 [2.96, 5.58] & 10.15 & .762 & High \\
Long Beach    & 209 & \textbf{.632} [.560, .710] & 4.47 [3.51, 5.51] & 8.63  & .746 & High \\
Kalaloch      & 235 & \textbf{.480} [.349, .641] & 3.78 [2.73, 5.09] & 10.14 & .813 & High \\
\addlinespace
Clatsop Bch   & 354 & .292 [$-$.229, .562] & 6.14 [4.85, 7.55] & 14.04 & .706 & Mod. \\
Gold Beach    & 257 & .051 [$-$.113, .236] & 8.02 [5.30, 10.78] & 23.45 & .763 & Mod. \\
\addlinespace
Cannon Bch    & 116 & $-$.045 [$-$.091, $-$.010] & 3.93 [1.38, 6.97] & 16.15 & .922 & Low \\
Coos Bay      & 109 & $-$.038 [$-$.681, .304] & 24.55 [18.75, 30.47] & 40.12 & .450 & Low \\
Newport       & 218 & $-$.243 [$-$1.51, $-$.017] & 10.30 [7.28, 14.13] & 28.28 & .610 & Low \\
\midrule
\textbf{Overall} & \textbf{2,181} & \textbf{.215} [.096, .342] & \textbf{6.42} [5.78, 7.15] & \textbf{17.79} & \textbf{.751} & --- \\
\bottomrule
\end{tabular*}
\vspace{0.3em}\\
...
\midrule
Quinault      & 144 & \textbf{.735} [.609, .831] & 2.72 [2.12, 3.40] & 4.69  & High \\
Copalis       & 152 & \textbf{.629} [.504, .753] & 3.20 [2.51, 3.96] & 5.56  & High \\
Long Beach    & 101 & \textbf{.628} [.452, .766] & 5.27 [3.83, 6.83] & 9.33  & High \\
Twin Harbors  & 103 & \textbf{.461} [.236, .712] & 5.18 [3.67, 7.04] & 10.26 & High \\
Clatsop Bch   & 118 & \textbf{.522} [.013, .770] & 9.78 [7.13, 12.73] & 18.69 & High$^\dagger$ \\
Coos Bay      &  89 & \textbf{.616} [.181, .857] & 8.08 [5.32, 11.55] & 16.78 & High$^\dagger$ \\
\addlinespace
Kalaloch      &  82 & .289 [.138, .612] & 2.55 [1.44, 3.92] & 6.31  & Mod. \\
Cannon Bch    &  13 & .000$^\ddagger$ & 0.03 & 0.03  & N/A$^\ddagger$ \\
Newport       & 124 & $-$.305 [$-$1.51, .129] & 12.88 [9.19, 17.16] & 25.15 & Low \\
Gold Beach    & 110 & $-$.271 [$-$2.34, $-$.048] & 10.56 [6.95, 15.04] & 24.96 & Low \\
\midrule
\textbf{Overall} & \textbf{1,036} & \textbf{.315} [.138, .476] & \textbf{6.55} [5.72, 7.43] & \textbf{15.35} & --- \\
\bottomrule
\end{tabular*}
\vspace{0.3em}\\
\footnotesize{MAE and RMSE in \si{\microgrampeg}. Bootstrap 95\% CIs ($B = 10{,}000$). $^\dagger$Clatsop Beach and Coos Bay shift from Moderate/Low on the standard eval to High on the temporal holdout ($R^2 > 0.4$); Coos Bay's improvement ($R^2 = 0.616$ vs.\ $-0.038$) is difficult to interpret given small $N = 89$. $^\ddagger$Cannon Beach ($N = 13$): insufficient post-2019 data; CI omitted.}
\end{table}
...
The 2019--2023 temporal holdout ($n = 1{,}036$, Table~\ref{tab:temporal-holdout}) provides additional validation. Pooled $R^2 = 0.315$ exceeds the standard result (0.215), as the post-2019 period contains proportionally more Washington test points and stronger autocorrelation. Washington sites achieve mean $R^2 = 0.549$; Oregon sites average $R^2 = 0.113$. The notable anomaly is Coos Bay ($R^2 = 0.616$ vs.\ $-0.038$ on the standard eval); the cause is unclear, and while a post-2019 change in DA dynamics at this site is one possibility, the small post-2019 sample ($N = 89$) makes this improvement difficult to interpret with confidence.
...
The near-equivalence of all four strategies ($R^2 = 0.190$--$0.221$) confirms that model-family selection is not a meaningful source of variance. Notably, the oracle---which selects the better model per site using test-set $R^2$ directly---achieves a \emph{lower} pooled $R^2$ (0.210) than the dev-set selection (0.215). This is not a paradox but a consequence of pooled $R^2$ not being a weighted average of per-site values: the oracle's site-optimal choices can concentrate residual error at high-$N$ sites that dominate the pooled metric, depressing the aggregate even while improving per-site fit. This illustrates why pooled metrics alone can be misleading for multi-site systems.
